...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Hasil Seleksi", "description": "Pengumuman Kelulusan Santri Baru" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "RegistrationResult", null, { "client:only": "react", "user": userProps, "registration": registration, "steps": steps, "client:component-hydration": "only", "client:component-path": "C:/Users/User/Documents/Rokib/Code/daftar-pondok/src/components/user/result", "client:component-export": "default" })} ` })}`;
}, "C:/Users/User/Documents/Rokib/Code/daftar-pondok/src/pages/user/result/index.astro", void 0);

const $$file = "C:/Users/User/Documents/Rokib/Code/daftar-pondok/src/pages/user/result/index.astro";
