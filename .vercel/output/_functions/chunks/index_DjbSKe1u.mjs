...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Upload Berkas", "description": "Upload Berkas Pendaftaran Santri Baru" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "DocumentUpload", null, { "client:only": "react", "userId": userId, "registrationId": registration?.id, "initialDocuments": documents, "user": userProps, "steps": steps, "client:component-hydration": "only", "client:component-path": "C:/Users/User/Documents/Rokib/Code/daftar-pondok/src/components/user/document", "client:component-export": "default" })} ` })}`;
}, "C:/Users/User/Documents/Rokib/Code/daftar-pondok/src/pages/user/document/index.astro", void 0);

const $$file = "C:/Users/User/Documents/Rokib/Code/daftar-pondok/src/pages/user/document/index.astro";
