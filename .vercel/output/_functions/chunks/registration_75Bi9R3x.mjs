import { mysqlTable, datetime, varchar, index } from 'drizzle-orm/mysql-core';
import { user } from './auth-schema_DxQznFiq.mjs';
import { profiles } from './profiles_DqcVxMfK.mjs';
import { r as registrationPaths, a as academicYears } from './registrationPath_cVteuG_V.mjs';
